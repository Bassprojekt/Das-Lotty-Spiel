        ...
        <div className="flex-1 flex flex-col gap-2 relative">
          {washingMode ? (
            ...
            <div data-desk="true" className="flex-1 relative rounded-xl border border-amber-900/30"
              ...
              {/* Trash Can - centered at bottom of desk */}
